...
import {assertSingleDockApp,readOwnMacApps} from './mac-app-policy.mjs';
...
const app=await _electron.launch({executablePath,env,timeout:60000});
try {
 ...
 const dock=assertSingleDockApp(executablePath);
